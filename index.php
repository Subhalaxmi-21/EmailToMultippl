...
<!-- Now need to input from signin -->
    ...
    <body class="bodycss">
        ...
        <h3 class="text-sm-right">Welcome <?php echo $_POST['user'] ?>!</h3>
        ...
        <form method="POST"  enctype="multipart/form-data" action="Update.php">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-8"><input type="file" id="attach" name="attach" accept=".doc, .jpg, .docx, .pdf, .png " ></div>
                </div>
                <br>
                <div class="row">
                    <div class="col-xs-12 col-sm-4">
                        <label for="receipt">Enter an excel sheet of receipent's emailid: </label>
                    </div>
                    <div class="col-xs-12 col-sm-8"><input type="file" id="receipt" name="receipt"></div>
                </div>
                <div class="row">
                    <div class="col-xs-12 col-sm-4">
                        <label for="adrec">Enter receipent's email address(if additional) :</label>
                    </div>
                    <div class="col-xs-12 col-sm-8"><input type="text" id='adrec' name='adrec' placeholder="E.g. Samuel@gmail.com "></div>
                </div>
                <br>
                <br>
                <div class="flexs">
    ...
    function showFileName() {
        var fil = document.getElementById("attach");
        alert(fil.value);
}
